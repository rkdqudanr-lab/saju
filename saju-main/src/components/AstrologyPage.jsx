      ...
      <div className="inner">
        <div style={{ paddingBottom: 40 }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: 32 }}>
            <div style={{ fontSize: 'var(--xl)', marginBottom: 8, color: 'var(--lav)' || 'var(--gold)' }}>✦</div>
            ...
            {sun && (
              <div style={{ display: 'flex', justifyContent: 'center', gap: 4, marginTop: 16, flexWrap: 'wrap' }}>
                <div style={{ background: 'var(--bg-glass)', border: '0.5px solid var(--line)', borderRadius: 8, padding: '4px 10px', fontSize: 'var(--xxs)', color: 'var(--t2)', fontWeight: 500 }}>
          ...
          {hasContent && (
            <>
              <div style={{ marginBottom: 20, padding: '16px', background: 'var(--bg-glass-heavy)', borderRadius: 'var(--r2)', border: '0.5px solid var(--line)', backdropFilter: 'blur(10px)', boxShadow: 'var(--shadow)' }}>
                <div style={{ fontSize: '10px', color: 'var(--t2)', fontWeight: 700, marginBottom: 4, letterSpacing: '0.1em', textTransform: 'uppercase' }}>✦ Full Astro Summary</div>
                <div style={{ fontSize: 'var(--xxs)', color: 'var(--t3)', fontWeight: 400 }}>태양 · 달 · 상승의 세 별빛으로 읽는 그대의 하늘지도</div>
              </div>
