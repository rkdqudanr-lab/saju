...
일일 운세 프롬프트는 `[시간대별 별숨]` 섹션을 생성한다. 아침(05:00~11:29), 오후(11:30~16:59), 저녁(17:00~19:59), 심야(20:00~04:59)의 음식/할일/조심/소통/한줄을 파싱해 홈 카드와 오늘 상세에서 시간대 탭으로 보여준다. 하루 점수와 9축 점수는 고정하고 시간대별 행동 조언만 달리한다.
