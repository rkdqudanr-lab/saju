...
function validateRequest(body) {
  ...
  const { userMessage, context, isChat, isReport, isLetter, isScenario, isStory, isDailyCard } = body;
...
export default async function handler(req, res) {
  ...
  const { userMessage, context, isChat, isReport, isLetter, isScenario, isStory, isDailyCard } = validation.data;
  ...
  const systemBase = await buildSystem(
    ...
    userMessage, isChat, isReport, isLetter, isScenario, isStory, isDailyCard
  );
