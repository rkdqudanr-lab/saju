...
export default async function handler(req, res) {
  ...
  const systemBase = await buildSystem(
    ...
    isDaeun, isAnalytics, precisionLevel, gender, isProphecy
  );
