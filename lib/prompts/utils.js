...
④ "다 잘 될 거예요" 같은 추상적 위로 금지. 행동에 시간·횟수·기간·금액 중 하나를 붙여 구체적으로 마무리해요. (예: "이번 주 금요일까지", "하루 20분", "5만원 범위 안에서")
...
③ 실용적인 행동 제안 1가지를 부드럽게 권해요 — 시간, 횟수, 기간 등 수치를 가능하면 포함해요. (예: "30분", "이번 주 안에", "한 달")
