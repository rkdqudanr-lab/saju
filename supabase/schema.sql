...
-- ================================================================
-- 신규 기능 마이그레이션 (익명 편지 및 팔로우)
-- ================================================================

-- ── anon_follows (익명 궁합 광장 팔로우) ─────────────────────────
create table if not exists public.anon_follows (
...
create index if not exists idx_anon_follows_follower on public.anon_follows(follower_id);
create index if not exists idx_anon_follows_following on public.anon_follows(following_id);
...
create index if not exists idx_anon_messages_receiver on public.anon_messages(receiver_id);
