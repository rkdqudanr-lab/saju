...
.upgrade-modal-bg{position:fixed;inset:0;background:rgba(0,0,0,.6);backdrop-filter:blur(6px);z-index:200;display:flex;align-items:center;justify-content:center;padding:var(--sp3)}
.upgrade-modal{background:var(--bg);border-radius:var(--r3);padding:var(--sp4) var(--sp3);width:100%;max-width:420px;animation:fadeUp .3s ease}
.upgrade-modal-title{font-size:var(--lg);font-weight:800;color:var(--t1);margin-bottom:6px}
.upgrade-modal-sub{font-size:var(--sm);color:var(--t3);margin-bottom:var(--sp3);line-height:1.7}
.upgrade-pkgs{display:flex;gap:10px;margin-bottom:var(--sp2)}
.upgrade-pkg{flex:1;padding:14px 10px;border-radius:var(--r1);border:1px solid var(--line);background:var(--bg2);text-align:center;cursor:pointer;transition:all .2s;position:relative}
.upgrade-pkg.chosen{border-color:var(--gold);background:var(--goldf)}
.upgrade-pkg:hover{border-color:var(--acc)}
.upgrade-pkg-e{font-size:1.5rem;margin-bottom:4px}
...
.upgrade-pkg-q{font-size:.6rem;color:var(--t4);margin-top:2px}
...
/* ══ 랜딩 신규 CTA ══ */
.land-start-primary{display:flex;align-items:center;justify-content:center;gap:8px;width:100%;padding:15px 20px;border-radius:var(--r2);border:none;background:linear-gradient(135deg,var(--gold),var(--gold2));color:#0D0B14;font-size:var(--md);font-weight:800;font-family:var(--ff);cursor:pointer;transition:all .2s;letter-spacing:-.01em;margin-bottom:10px}
.land-start-primary:hover{transform:translateY(-1px);box-shadow:0 8px 24px rgba(232,176,72,.35)}
.land-start-primary:active{transform:translateY(0)}
.land-kakao-secondary{display:flex;align-items:center;justify-content:center;gap:7px;width:100%;padding:11px 16px;border-radius:var(--r1);border:1px solid var(--line);background:var(--bg2);color:var(--t3);font-size:var(--sm);font-weight:500;font-family:var(--ff);cursor:pointer;transition:all .2s;letter-spacing:.01em}
.land-kakao-secondary:hover{border-color:#FEE500;background:rgba(254,229,0,.06);color:#FEE500}
.land-kakao-secondary .kakao-icon-wrap{width:20px;height:20px;border-radius:50%;background:#FEE500;display:flex;align-items:center;justify-content:center;flex-shrink:0}
