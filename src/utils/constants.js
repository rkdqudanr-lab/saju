...
━━━ 응답 구조 ━━━
첫 문장: 오늘 일어난 일이 왜 지금 이 시기에 나타났는지 — 타이밍 근거를 구체적으로 (예: "지금은 결단력이 강해지는 시기라 이 선택이 자연스럽게 밀려왔어요", "표현이 활발해지는 때라 이 감정이 터져나온 거예요").
둘째 문단: 오늘 느낀 감정이나 상황을 사주 기질(타고난 성향)과 연결해서 해석해요. "당신은 원래 ~한 기질이라 ~한 상황에서 이런 감정이 자주 와요" 형식.
셋째 문단: 앞으로 이 상황을 어떻게 받아들이면 좋은지 — 이번 주 또는 이번 달 안에 할 수 있는 구체적 행동 하나로 제안해요 (예: "이번 주 안에 그 사람에게 연락 한 번 해봐요", "내일부터 자기 전 5분만 그 일 정리해봐요").
...
export const SIGN_MOOD = {
  ...
  '천칭자리': {color:'#C4A8D8',bg:'rgba(196,168,216,.1)',word:'균형잡힌 심미안',emoji:'♎'},
  '전갈자리': {color:'#9B4EC4',bg:'rgba(155,78,196,.1)',word:'깊고 강렬한',emoji:'♏'},
  '사수자리': {color:'#E8A048',bg:'rgba(232,160,72,.1)',word:'자유롭고 낙천적',emoji:'♐'},
  '염소자리': {color:'#8A8A8A',bg:'rgba(138,138,138,.1)',word:'묵직한 뚝심',emoji:'♑'},
...
export const CATS_ALL=[
  ...
  {id:"legal",icon:"♎",label:"소송·관재",qs:["현재 진행 중인 일이나 소송이 저에게 유리하게 끝날까요?","올해 조심해야 할 구설수나 관재수가 있나요?","오해나 억울한 상황이 해결될 수 있을까요?"]},
  {id:"hobby",icon:"◇",label:"취미·적성",qs:["사주에 나타난 저만의 숨겨진 예술적 재능이 있나요?","어떤 취미를 가지면 제 운이 크게 좋아질까요?","부업이나 직업으로 연결될 수 있는 적성이 있을까요?"]},
  {id:"travel",icon:"↗",label:"여행·이동",qs:["이번 여행이 잘 될까요? 어떤 점을 주의해야 할까요?","올해 해외 이동에 좋은 방향이나 시기가 있나요?"]},
