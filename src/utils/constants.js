...
// ═══════════════════════════════════════════════════════════
export const TIMING = {
  typingWord: 87,      // AccItem 기본 타이핑 (단어 간격 ms)
  typingChat: 27,      // 채팅 버블 타이핑
  typingReport: 23,    // 리포트 타이핑
  sampleChar: 19,      // SamplePreview 기본 문자 딜레이
  samplePunct: 187,    // 문장부호 딜레이 (. ! ?)
  sampleComma: 80,     // 쉼표 딜레이
  sampleNewline: 133,  // 개행 딜레이
