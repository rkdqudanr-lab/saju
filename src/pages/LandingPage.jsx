                          ...
                          <>
                            {isAfter5 ? (
                              <>
                                ...
                                {showDailyCard && <div style={{ marginTop: 8 }}>{dailyCardContent}</div>}
                              </>
                            ) : (
                              <>
                            ...
                            {/* 별숨달력 */}
                            {formOk && (
                              <button className="cta-main" style={{ width: '100%', justifyContent: 'center', borderRadius: 'var(--r1)', padding: '12px', marginTop: 10, background: 'none', border: '1px solid var(--line)', color: 'var(--t2)' }} onClick={() => setStep(10)}>
                                🗓️ 별숨달력 ✦
                              </button>
                            )}
                          </>
